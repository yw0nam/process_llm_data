...
# %%
csv = pd.read_json('/data2/datas/LLM/visual_novel/processed/target_chara_chat.json')
# %%
...
# %%
jdump(dataset,'/data2/datas/LLM/visual_novel/processed/target_chara_chat_preference.json')
