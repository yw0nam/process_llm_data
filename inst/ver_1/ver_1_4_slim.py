...
class preprocess(preprocess):
    ...
    def Aratako_Synthetic_JP_EN_Coding_Dataset_Magpie_69k(self):
        pass
    def Aratako_Synthetic_JP_EN_Coding_Dataset_801k(self, sample_size=20000, random_state=1004):
        ...
        return data
    def Magpie_Tanuki_8B_97k(self, sample_size=20000, random_state=1004):
